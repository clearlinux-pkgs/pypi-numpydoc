...
Source0  : https://files.pythonhosted.org/packages/76/69/d745d43617a476a5b5fb7f71555eceaca32e23296773c35decefa1da5463/numpydoc-1.7.0.tar.gz
...
%prep
%setup -q -n numpydoc-1.7.0
cd %{_builddir}/numpydoc-1.7.0
pushd ..
cp -a numpydoc-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711641453
