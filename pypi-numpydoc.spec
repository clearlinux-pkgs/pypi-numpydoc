...
Source0  : https://files.pythonhosted.org/packages/2f/19/7721093e25804cc82c7c1cdab0cce6b9343451828fc2ce249cee10646db5/numpydoc-1.9.0.tar.gz
...
%prep
%setup -q -n numpydoc-1.9.0
cd %{_builddir}/numpydoc-1.9.0
pushd ..
cp -a numpydoc-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750773635
